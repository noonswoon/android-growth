...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDialogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imageAds.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(MainActivity.this, "Link to Googleplay store", Toast.LENGTH_LONG).show();
                    }
                });
                dialog.show();
            }
        ...
        mLoginButton.setReadPermissions(Arrays.asList("public_profile, email, user_likes, user_photos, user_birthday, email"));
        ...
        GraphRequest request = GraphRequest.newMeRequest(
                ...
                new GraphRequest.GraphJSONObjectCallback() {
                    ...
                    public void onCompleted(
                        ...
                        try {
                            mNameTextView.setText(String.format("%s %s", object.getString("first_name"), object.getString("last_name")));
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                        try {
